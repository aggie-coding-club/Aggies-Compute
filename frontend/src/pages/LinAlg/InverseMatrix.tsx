        ...
        <div className="flex flex-col w-[60%] mt-20">
          ...
          <div className="bg-[#DCEFF0] p-5 mt-5">
            ...
            <div className="flex space-x-5">
              ...
              <input type="number" id="input" min="1" className="w-full max-w-20 bg-gray-100 rounded-xl p-2.5 text-black focus:bg-transparent focus:outline-none transform: transition duration-100 hover:bg-gray-50 hover:scale-105 motion-reduce:transform-none" placeholder="3" title="Enter a width" required/>
              {/* <Input type="number" rounded css={{ $$inputColor: "#ffffff" }} initialValue="3" title="Enter a width" shadow={false} required/> */}
              <p>
                X
              </p>
              <input type="number" id="input" min="1" className="w-full max-w-20 bg-gray-100 rounded-xl p-2.5 text-black focus:bg-transparent focus:outline-none transform: transition duration-100 hover:bg-gray-50 hover:scale-105 motion-reduce:transform-none" placeholder="3" title="Enter a length" required/>
            </div>
            < br/>
            <p>
              Enter your matrix
