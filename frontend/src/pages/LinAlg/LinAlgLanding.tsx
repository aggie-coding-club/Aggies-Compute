...
const lin_items = [
  ...
  >
    <div className="flex flex-col items-center justify-center h-48 mx-5">
      ...
      <p className='font-bold mt-8 text-white text-xl'>Row Echelon Form</p>
    </div>
  </NavLink>,
...
transform transition duration-500 scale-95 hover:scale-100 hover:bg-opacity-60"
  >
    <div className="flex flex-col items-center justify-center h-48 mx-5">
      ...
      <p className='font-bold mt-8 text-white text-xl'>Inverse Matrix</p>
    </div>
  </NavLink>,
...
transform transition duration-500 scale-95 hover:scale-100 hover:bg-opacity-60"
  >
    <div className="flex flex-col items-center justify-center h-48 mx-5">
      ...
      <p className='font-bold mt-8 text-white text-xl'>Matrix Operations</p>
    </div>
  </NavLink>,
