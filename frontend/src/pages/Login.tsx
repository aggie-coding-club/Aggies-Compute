...
-95z"/>
                    ...
                    </svg>Sign In with Email<div></div></button>
                </div>
                <div className='text-white mt-5'>
                    Don't have account? <span className='text-primary_blue-light-0'>
                        <NavLink to="/registration" className=" no-underline hover:underline"> Sign Up </NavLink>
                    </span>
                </div>
            </div>
        </div>
