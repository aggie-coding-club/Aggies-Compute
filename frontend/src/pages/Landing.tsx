...
export default function Landing() {
  return (
    <div className="bg-bg_grey">
      ...
      {/* landing-page-header */}
      <div className="flex flex-col w-full h-56 items-center w-full bg-gradient-to-b from-primary_blue-dark to-primary_blue via-primary_blue animate-gradient-y ">
        <h1 className="flex items-center w-full h-1/3 pt-6 justify-center text-6xl font-extrabold  text-primary_blue-light-2">
          Aggie <span className="text-primary_blue-dark">Compute</span>
        </h1>
