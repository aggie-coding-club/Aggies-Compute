export function add(functions:string[]):string{
    ...
    /*  Algorithm
        ...
        4. Once all terms have been matched/added, repair the coefficients to their respective variables
...
export function subtract(functions: string[]): string{
    ...
    /*  Algorithm
        ...
        5. Once all terms have been matched/added, repair the coefficients to their respective variables
