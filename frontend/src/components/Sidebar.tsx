...
// map function
export default function Sidebar(info: any) {
    var title: string = info.info.title;
    var links: string[] = info.info.links;
    var names: string[] = info.info.names;
    return (
                        ...
                        <ul className="pt-2 pb-4 space-y-1 text-sm px-5">
                            {links.map((link, index) => (
                                <li className="flex flex-col items-center justify-center">
                                    <NavLink to={link} className="font-bold text-base">
                                        {names[index]}
                                    </NavLink>
